...
<title>Zasedačka</title><meta name="theme-color" content="#d94f86"><link rel="icon" type="image/png" sizes="180x180" href="/apple-touch-icon.png"><link rel="apple-touch-icon" sizes="180x180" href="/apple-touch-icon.png">
<style>
...
export default {
  async fetch(request, env) {
    ...
    try {
      if (url.pathname === '/apple-touch-icon.png' && request.method === 'GET') return iconPng();
