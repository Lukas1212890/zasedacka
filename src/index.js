...
.field textarea{font:inherit;border:1px solid var(--line);border-radius:10px;padding:12px;background:white;min-width:0;resize:vertical}.field textarea:focus{outline:2px solid #f4a8c7;border-color:var(--accent)}
</style></head><body>
